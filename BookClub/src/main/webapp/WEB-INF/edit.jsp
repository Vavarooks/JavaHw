...
<body>
	<h1 class="col-6">Change your Entry</h1>
	<div class="d-flex">
		<div class="d-block border border-dark p-4 card mx-auto w-50">
			<form:form modelAttribute="book" method="PUT" action="/changes/${book.id}">
				<div class="row">
					<div class="col-12">
					...
					<div class="col-12">
						<form:label path="review" class="form-label">review</form:label>
